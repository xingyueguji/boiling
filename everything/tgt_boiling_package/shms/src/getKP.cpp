...
//choice 1 DIS
//choice 1 Hybrid
TGraph* getKP(string what= "dis/hybrid/aold/akp17", string angle="21"){
  ...
  int ncols=7;
  if(what=="dis" || what == "hybrid"){
    fname=Form("src/moreModels/%s_model.dat",what.c_str());
    ncols=4;
  }
  if(what=="aold")fname="src/moreModels/a08old_e1210002.dat";
  if(what=="akp17")fname="src/moreModels/akp17_e1210002.dat";
  file.open(fname);

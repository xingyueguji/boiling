...
void compare(string targ="LD2")
{
  ...
  TGraph *gr1b=plotBill(2.01,"SHMS",1);
  TGraph *gr2b=plotBill(2.01,"SHMS",2);
  TGraph *gr3b=plotBill(2.01,"SHMS",3);
  TGraph *gr4b=plotBill(2.01,"SHMS",4);
  TGraph *gr5b=plotBill(2.01,"SHMS",5);
  ...
  gr1b->GetYaxis()->SetRangeUser(3150,3400);

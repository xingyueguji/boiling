...
TPaveStats* formatit(TGraphErrors *g, int style, int color){
  ...
  fun->SetParNames("y-int","slope (%/uA)");
  g->Fit("fun");
  gPad->Update();
...
void plotAllSlopes()
{
  ...
  TGraph *gr1=plotCarlos(18,23,"LD2");//traacking yield
  TGraph *gr1e=plotCarlos(18,24,"LD2");//traacking yield
  TGraph *gr2=plotCarlos(18,21,"LD2");//non-tracking yield
  TGraph *gr2e=plotCarlos(18,22,"LD2");//non-tracking yield
  TGraph *gr3=plotCarlos(18,19,"LD2");//scaler 
  TGraph *gr3e=plotCarlos(18,20,"LD2");//scaler 
 ...
 TPaveStats *st3=formatit(g_scaler_lh2_shms, 31, 1);
  ...
  g_track_lh2_shms->SetTitle("SHMS LD2 Boiling");

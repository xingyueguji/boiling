		 ...
		 )
{
  ...
  TString filename=Form("../../../ROOTfiles/hms_replay_tgt_boiling_%d_-1.root", runNum); 
    ...
    filename=Form("/volatile/hallc/spring17/wmhenry/f2/boiling/f2_with_yeroCalCuts/hms_replay_production_%d_-1.root", runNum) ;  
    filename=Form("/volatile/hallc/spring17/wmhenry/ROOTfiles/boilingTest/hms_replay_tgt_boiling_%d_-1.root", runNum) ;  
    filename=Form("/volatile/hallc/spring17/wmhenry/f2/boiling/hms_replay_production_%d_-1.root", runNum) ;  

    filename=Form("/volatile/hallc/spring17/wmhenry/f2/boiling/tightCuts/hms_replay_production_%d_-1.root", runNum) ;  
    //    filename=Form("/volatile/hallc/spring17/wmhenry/f2/boiling/wideCuts/hms_replay_production_%d_-1.root", runNum) ;  
  ...
  //for (int i = 0; i < 5; i++) {
    ...
    */
    ...
    //-----SCALER YIELD-----
    //BCM4A
    scl_Yield_bcm4a = (total_htrig3_scaler_bcm4a_cut-total_hedtm_scaler_bcm4a_cut) / (total_charge_bcm4a_cut);
    scl_err_bcm4a = sqrt(total_htrig3_scaler_bcm4a_cut) / total_charge_bcm4a_cut;
    //BCM4B
    scl_Yield_bcm4b = (total_htrig3_scaler_bcm4b_cut-total_hedtm_scaler_bcm4b_cut) / (total_charge_bcm4b_cut);
    scl_err_bcm4b = sqrt(total_htrig3_scaler_bcm4b_cut) / total_charge_bcm4b_cut;

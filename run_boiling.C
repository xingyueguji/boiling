		 ...
		 )
{
  ...
  //Define Constants
  //Int_t runNum = 2093;
  Double_t current_thrs_bcm4a = 2.;
  Double_t current_thrs_bcm4b = 2.;

  Double_t pS;   //Pre-Scale FActor


  //HMS C12 Boiling Study
  if(runNum==1523){
    set_current = 35.;
    pS = 9;
    //eTrkEff = 0.9931;  
  ...
  TString filename=Form("ROOTfiles/COIN/PRODUCTION/nps_hms_coin_%d_1_-1.root", runNum); 
